...
export USE_LOCAL_NIM="${USE_LOCAL_NIM:-true}"
export GX10_IP="${GX10_IP:-localhost}"
export AGENTS_USE_MOCK="${AGENTS_USE_MOCK:-false}"
export FLEET_MASTER_ONLY="${FLEET_MASTER_ONLY:-true}"
export ALL_AGENTS_LLM="${ALL_AGENTS_LLM:-false}"
export USE_LLM_TASK_INTERPRETER="${USE_LLM_TASK_INTERPRETER:-true}"
export COOPERATIVE_PATHING="${COOPERATIVE_PATHING:-false}"
export FACTORYMIND_AUTO_START="${FACTORYMIND_AUTO_START:-false}"
export NEMOTRON_TIMEOUT_SECONDS="${NEMOTRON_TIMEOUT_SECONDS:-60}"
